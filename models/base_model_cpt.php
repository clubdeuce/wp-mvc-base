...
if ( ! class_exists( 'Base_Model_CPT' ) && class_exists( 'Base_Model' ) ):
	 ...
	 */
	 ...
	 {
	 	/**
		 * The cpt slug. Will be used to register the post type.
		 *
		 * @var string
		 * @access protected
		 * @since 0.1
		 ...
		 *
		 * This property is an array containing individual help screen object.
		 *
		 * @var array
		 * @access protected
		 * @since 0.1
		...
		{
			return register_post_type( $this->_slug, $this->_args );	
		}
