...
if ( ! class_exists( 'WPMVCB_Settings_Model_Base' ) ) {
	/**
	 ...
	 * @since   WPMVCBase 0.1
	 */
	abstract class WPMVCB_Settings_Model_Base extends WPMVCB_Model_Base {
